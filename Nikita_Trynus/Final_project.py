...
def start(update, context):
    ...
    update.message.reply_text("Good evening moy gospodine")


def prosit_bali(update, context):
    """
    Message handler Postav sto
    """
    update.message.bot.send_message(
        update.message.chat_id,
        "Yura, poshaluysta primi project, mne nuzhno delat javu(((("
    )
...
def main():
    ...
    dp.add_handler(MessageHandler(Filters.regex('Postav sto'), prosit_bali))
