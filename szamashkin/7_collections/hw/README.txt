...
2. My Pizzas, Your Pizzas: Make a copy of the list of pizzas, and call it friend_pizzas. Then, do the following:
...
5. Glossary: A Python dictionary can be used to model an actual dictionary. However, to avoid confusion, let’s call it a glossary.
